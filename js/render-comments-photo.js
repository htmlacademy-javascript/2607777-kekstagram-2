...
const bigPictureSocialComments =
  bigPictureForm.querySelector('.social__comments');
const socialCommentTemplate =
  bigPictureSocialComments.querySelector('.social__comment');
const bigPictureCommentsCount = bigPictureForm.querySelector(
  '.social__comment-count'
);
const bigPictureCommentsLoaderButton = bigPictureForm.querySelector(
...
const renderNextComments = () => {
  ...
  bigPictureCommentsCount.querySelector(
...
export const clearComments = () => {
  ...
  bigPictureCommentsLoaderButton.removeEventListener(
    'click',
    renderNextComments
  );
};
